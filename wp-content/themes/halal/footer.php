		...
		<div class="top">
			...
			<div class="right">
				<form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <input type="email" name="your-email" id="enter-email" placeholder="<?= (pll_current_language() == 'en') ? "Enter your email" : "Nhập email của bạn" ?>" required>
                    <button type="submit"><?= (pll_current_language() == 'en') ? "Register" : "Đăng ký" ?></button>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (getCookie('registration_success') === 'true') {
        alert('Đăng ký nhận tin mới thành công!');
        // Delete the cookie after showing the alert
        document.cookie = 'registration_success=; Max-Age=0; path=/;';
    }

    if (getCookie('registration_error') === 'email_exists') {
        alert('Email của bạn đã đăng ký nhận thông tin');
        // Delete the cookie after showing the alert
