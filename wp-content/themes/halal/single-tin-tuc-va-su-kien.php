...
$news_and_event_id = get_the_ID();
$news_and_event = get_field('news-and-event', $news_and_event_id);

$thumbnail = get_the_post_thumbnail_url(get_the_ID(), 'full');
$address = $news_and_event['address'];
        ...
        <div class="container">
            ...
            <div class="left">
                ...
                <div class="share">
                    ...
                    ?>
                    <a href="https://www.facebook.com/sharer.php?u=<?php echo $current_url; ?>" target="_blank" class="facebook">
                    ...
                    <a href="https://twitter.com/intent/tweet?url=<?php echo $current_url; ?>&text=<?php echo $title; ?>" target="_blank" class="twitter">
                        <svg xmlns="http://www.w3.org/2000/svg" width="33" height="32" viewBox="0 0 33 32" fill="none">
