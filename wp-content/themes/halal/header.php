	...
	<header>
			...
			<div class="container">
				...
				<?php if (pll_current_language() == 'en-us') : ?>
					<div class="mega-menu">
						<ul>
							<li class="child">
								<a href="<?= home_url() ?>/en-us/about-halcert">About HALCERT</a>
							</li>
							<li class="child">
								<a>Service</a>
								...
								<div class="down" id="down-menu-header-1">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 20" fill="none">
								...
								<nav class="sub-menu sub-menu-1" id="sub-menu-1">
									<ul>
										<li><a href="<?= home_url() ?>/en-us/training">Training</a></li>
										<li><a href="<?= home_url() ?>/en-us/cretify">Cretify</a></li>
									</ul>
								</nav>
							</li>
							<li class="child">
								<a href="<?= home_url() ?>/en-us/halal-nqi-en">Halal NQI</a>
							</li>
							<li class="child">
								<a href="<?= home_url() ?>/en-us/customer">Customer</a>
							</li>
							<li class="child">
								<a href="<?= home_url() ?>/en-us/news-and-event">News & Event</a>
							</li>
							<li class="child">
								<a href="<?= home_url() ?>/en-us/halal-journal">Halal Journal</a>
								<div class="up" id="drop-menu-header-2">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 20" fill="none">
										<path fill-rule="evenodd" clip-rule="evenodd" d="M4.22603 12.7337C4.4701 12.9778 4.86583 12.9778 5.10991 12.7337L9.9373 7.90618C10.0187 7.82491 10.1505 7.82491 10.232 7.90618L15.0594 12.7337C15.3035 12.9778 15.6991 12.9778 15.9432 12.7337C16.1873 12.4896 16.1873 12.0939 15.9432 11.8498L11.1158 7.02236C10.5463 6.45286 9.62297 6.45286 9.05347 7.02236L4.22603 11.8498C3.98195 12.0939 3.98195 12.4896 4.22603 12.7337Z" fill="black"/>
									</svg>
								</div>
								<div class="down" id="down-menu-header-2">
									<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 20" fill="none">
										<path fill-rule="evenodd" clip-rule="evenodd" d="M4.22603 7.26631C4.4701 7.02224 4.86583 7.02224 5.10991 7.26631L9.9373 12.0938C10.0187 12.1751 10.1505 12.1751 10.232 12.0938L15.0594 7.26631C15.3035 7.02223 15.6991 7.02223 15.9432 7.26631C16.1873 7.51039 16.1873 7.90611 15.9432 8.1502L11.1158 12.9776C10.5463 13.5471 9.62297 13.5471 9.05347 12.9776L4.22603 8.1502C3.98195 7.90612 3.98195 7.51039 4.22603 7.26631Z" fill="black"/>
									</svg>
								</div>
								<nav class="sub-menu sub-menu-2" id="sub-menu-2">
									<ul>
							...
							<li class="child">
								<a href="<?= home_url() ?>/en-us/contact">Contact</a>
							</li>
						</ul>
					</div>
					<div class="button">
						<a href="<?= home_url() ?>/en-us/register-cretify">Register cretify</a>
					</div>
				<?php else: ?>
					<div class="mega-menu">
						<ul>
							...
							<li class="child">
								...
								<nav class="sub-menu sub-menu-1" id="sub-menu-1">
									<ul>
										<li><a href="<?= home_url() ?>/dao-tao">Đào tạo</a></li>
										<li><a href="<?= home_url() ?>/chung-nhan">Chứng nhận</a></li>
									</ul>
								</nav>
							</li>
							<li class="child">
        ...
        <div id="menuHeader" class="menu-mobile">
			...
			<?php if (pll_current_language() == 'en-us') : ?>
				<nav class="nav-menu">
					<ul>
						<li><a href="<?= home_url() ?>/en-us/about-halcert">About HALCERT</a></li>
						<li>
							<a>Service</a>
							...
							<div class="down" id="down-menu-mobile-1">
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 20" fill="none">
									<path fill-rule="evenodd" clip-rule="evenodd" d="M4.22603 7.26631C4.4701 7.02224 4.86583 7.02224 5.10991 7.26631L9.9373 12.0938C10.0187 12.1751 10.1505 12.1751 10.232 12.0938L15.0594 7.26631C15.3035 7.02223 15.6991 7.02223 15.9432 7.26631C16.1873 7.51039 16.1873 7.90611 15.9432 8.1502L11.1158 12.9776C10.5463 13.5471 9.62297 13.5471 9.05347 12.9776L4.22603 8.1502C3.98195 7.90612 3.98195 7.51039 4.22603 7.26631Z" fill="black"/>
								</svg>
							</div>
							<nav class="sub-menu" id="sub-menu-mobile-1">
								<ul>
									<li><a href="<?= home_url() ?>/en-us/training">Training</a></li>
									<li><a href="<?= home_url() ?>/en-us/cretify">Cretify</a></li>
								</ul>
						...
						<li><a href="<?= home_url() ?>/en-us/halal-nqi-en">Halal NQI</a></li>
						<li><a href="<?= home_url() ?>/en-us/customer">Customer</a></li>
						<li><a href="<?= home_url() ?>/en-us/news-and-event">News & Event</a></li>
						<li>
							<a href="<?= home_url() ?>/en-us/halal-journal">Halal Journal</a>
							<div class="up" id="drop-menu-mobile-2">
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 20" fill="none">
									<path fill-rule="evenodd" clip-rule="evenodd" d="M4.22603 12.7337C4.4701 12.9778 4.86583 12.9778 5.10991 12.7337L9.9373 7.90618C10.0187 7.82491 10.1505 7.82491 10.232 7.90618L15.0594 12.7337C15.3035 12.9778 15.6991 12.9778 15.9432 12.7337C16.1873 12.4896 16.1873 12.0939 15.9432 11.8498L11.1158 7.02236C10.5463 6.45286 9.62297 6.45286 9.05347 7.02236L4.22603 11.8498C3.98195 12.0939 3.98195 12.4896 4.22603 12.7337Z" fill="black"/>
								</svg>
							</div>
							<div class="down" id="down-menu-mobile-2">
								<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 21 20" fill="none">
									<path fill-rule="evenodd" clip-rule="evenodd" d="M4.22603 7.26631C4.4701 7.02224 4.86583 7.02224 5.10991 7.26631L9.9373 12.0938C10.0187 12.1751 10.1505 12.1751 10.232 12.0938L15.0594 7.26631C15.3035 7.02223 15.6991 7.02223 15.9432 7.26631C16.1873 7.51039 16.1873 7.90611 15.9432 8.1502L11.1158 12.9776C10.5463 13.5471 9.62297 13.5471 9.05347 12.9776L4.22603 8.1502C3.98195 7.90612 3.98195 7.51039 4.22603 7.26631Z" fill="black"/>
								</svg>
							</div>
							<nav class="sub-menu" id="sub-menu-mobile-2">
								<ul>
									<?php foreach ($categories as $category) { ?>
										<li><a href="<?= home_url() ?>/danh_muc_tap_san/<?= $category->slug ?>"><?= $category->name ?></a></li>
									<?php } ?>
