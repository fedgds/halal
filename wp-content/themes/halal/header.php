	...
	<header>
        ...
        <div id="menuHeader" class="menu-mobile">
			...
			<?php if (pll_current_language() == 'en') : ?>
				<nav class="nav-menu">
					<ul>
						<li><a href="<?= home_url() ?>/en/about-halcert">About HALCERT</a></li>
						<li>
							<a>Service</a>
							<div class="icon">
							...
							<nav class="sub-menu" id="sub-menu-mobile-1">
								<ul>
									<li><a href="<?= home_url() ?>/en/training">Training</a></li>
									<li><a href="<?= home_url() ?>/en/certification">Cretify</a></li>
								</ul>
							</nav>
						</li>
						<li><a href="<?= home_url() ?>/en/halal-nqi-en">Halal NQI</a></li>
						<li><a href="<?= home_url() ?>/en/customer">Customer</a></li>
						<li><a href="<?= home_url() ?>/en/news-and-event">News & Event</a></li>
						<li>
							<a href="<?= home_url() ?>/en/halal-journal">Halal Journal</a>
							<div class="icon">
						...
						<li><a href="<?= home_url() ?>/en/contact">Contact</a></li>
						<li class="register"><a href="<?= home_url() ?>/en/register-cretify">Register cretify</a></li>
					</ul>
				</nav>
			<?php else: ?>
				<nav class="nav-menu">
