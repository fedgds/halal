			...
			<div class="container">
				...
				<div class="mega-menu">
					<ul>
						...
						<li class="child">
							<a href="<?= home_url() ?>">Dịch vụ</a>
						</li>
						<li class="child">
							<a href="<?= home_url() ?>">Halal NQI</a>
						</li>
						<li class="child">
							<a href="<?= home_url() ?>">Khách hàng</a>
						</li>
						<li class="child">
							<a href="<?= home_url() ?>">Tin tức & Sự kiện</a>
						</li>
						<li class="child">
							...
							<nav class="sub-menu" id="sub-menu">
								<ul>
									<li><a href="<?= home_url() ?>">Chính sách</a></li>
									<li><a href="<?= home_url() ?>">Thông tin thị trường</a></li>
									<li><a href="<?= home_url() ?>">Tiêu chuẩn và Chứng nhận</a></li>
									<li><a href="<?= home_url() ?>">Hợp tác và Phát triển</a></li>
									<li><a href="<?= home_url() ?>">Thông tin hữu ích cho doanh nghiệp</a></li>
								</ul>
							</nav>
						</li>
						<li class="child">
							<a href="<?= home_url() ?>">Liên hệ</a>
						</li>
					</ul>
				</div>
				<div class="button">
					<a href="<?= home_url() ?>">Đăng ký chứng nhận</a>
				</div>
			</div>
		</div>
        ...
        <div id="menuHeader" class="menu-mobile">
            ...
            <nav class="nav-menu">
                <ul>
                    ...
                    <li><a href="#">Halal NQI</a></li>
                    <li><a href="#">Khách hàng</a></li>
                    <li><a href="#">Tin tức & Sự kiện</a></li>
                    <li><a href="#">Tập san Halal</a></li>
                    <li><a href="#">Liên hệ</a></li>
                    <li><a href="#">Đăng ký chứng nhận</a></li>
                </ul>
            </nav>
        </div>
	</header>
