        ...
        <div class="container">
            ...
            <div class="bottom">
                <div class="list-training">
                    <div class="child">
                        <a class="image" href="<?= home_url() ?>">
                            <img src="<?= $url ?>/dist/images/training-1.png" alt="">
                        </a>
                        <div class="infor">
                            <h3 class="title"><a href="">Khóa đào tào về chứng chỉ Halal của HALCERT cung cấp</a></h3>
                            <div class="date">
                                <div class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
        ...
        <div class="container">
            <div class="top">
                ...
                <nav class="tab">
                    <ul>
                        <li>Tiêu chuẩn</li>
                        <li class="active">Tiêu chuẩn Halal</li>
                        <li>Thử nghiệm</li>
                        <li>Chứng nhận</li>
    ...
    <div class="section-7-home">
        <div class="container">
            <div class="top">
                ...
                <nav class="tab">
                    <ul>
                        <li class="active">Tin tức mới nhất</li>
            ...
            <div class="bottom">
                ...
                <div class="right">
                    <div class="child">
                        <h3>Google Update: Phiên bản Google Workspace Business Starter được chuyển sang cơ chế gộp bộ nhớ và có thêm tính năng bộ nhớ dùng chung</h3>
                        <div class="date-and-views">
                            <div class="date">
                                <div class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="child">
                        <h3>CMC Telecom bật mí phương thức đột phá doanh thu với Google Data Warehouse</h3>
                        <div class="date-and-views">
                            <div class="date">
                                <div class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                    ...
                    <div class="child">
                        <h3>Miễn phí nâng cấp Google Workspace cùng CMC Telecom</h3>
                        <div class="date-and-views">
                            <div class="date">
                                <div class="icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
