            ...
            <div class="bottom">
                <div class="left" id="tab-news">
                    <div class="list-news">
                        <?php if ($list_latest_news_query->have_posts()) : ?>
                            ...
                            <?php while ($list_latest_news_query->have_posts()) : $list_latest_news_query->the_post(); ?>
                                <?php
                                    $news_id = get_the_ID();
                ...
                <div class="right">
                    <?php if ($list_featured_news_query->have_posts()) : ?>
                        <?php $count = 0; ?>
                            <?php while ($list_featured_news_query->have_posts()) : $list_featured_news_query->the_post(); ?>
                                <?php
                                    $news_id = get_the_ID();
                                    $news = get_field('news-and-event', $news_id);
                                    $thumbnail_url = get_the_post_thumbnail_url(get_the_ID(), 'full');
