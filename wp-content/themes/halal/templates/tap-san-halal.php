...
<main>
    ...
    <div class="section-halal">
        <div class="container">
            ...
            <div class="list-menu">
                <h2 class="title">Thông tin thị trường</h2>
                <div class="list">
                    <div class="child">
                        <a href="">
                            <img src="<?= $url ?>/dist/images/section-7-image-1.png" alt="">
            ...
            <div class="list-menu">
                <h2 class="title">Tiêu chuẩn & Chứng nhận</h2>
                <div class="list">
                    <div class="child">
                        <a href="">
                            <img src="<?= $url ?>/dist/images/section-7-image-1.png" alt="">
            ...
            <div class="list-menu">
                <h2 class="title">Hợp tác & Phát triển</h2>
                <div class="list">
                    <div class="child">
                        <a href="">
                            <img src="<?= $url ?>/dist/images/section-7-image-1.png" alt="">
            ...
            <div class="list-menu">
                <h2 class="title">Thông tin hữu ích cho doanh nghiệp</h2>
                <div class="list">
                    <div class="child">
                        <a href="">
                            <img src="<?= $url ?>/dist/images/section-7-image-1.png" alt="">
