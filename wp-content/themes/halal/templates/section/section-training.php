...
<div class="section-banner">
    <div class="banner">
        <img src="<?= $url ?>/dist/images/banner-customer.png" alt="">
    </div>
    ...
    <div class="container">
        <div class="bot">
            ...
            <a href="">Đào tạo Halal</a>
        </div>
        <h2 class="title">ĐÀO TẠO HALAL</h2>
        <span>Lorem ipsum dolor sit amet consectetur. Rhoncus vulputate pretium magna platea pellentesque nibh vulputate mi.</span>
    </div>
</div>