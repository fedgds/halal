            ...
            <div class="container">
                ...
                <div class="list-customer" id="list-tab-customer">
                    <div class="wrap">
                        ...
                        <?php else : ?>
                            <p><?= (pll_current_language() == 'en-us') ? "There are no customers." : "Không có khách hàng nào." ?></p>
                        <?php endif; ?>
                    </div>
                </div>   
                                        ...
                                        <div class="bottom">
                                            <div class="child">
                                                <div class="left">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en-us') ? "Certificate number:" : "Số chứng nhận:" ?></b>
                                                </div>
                                            ...
                                            <div class="child">
                                                <div class="left">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en-us') ? "Certificate scope:" : "Phạm vi chứng nhận:" ?></b>
                                                </div>
                                            ...
                                            <div class="child">
                                                <div class="left">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en-us') ? "Certificate validity:" : "Hiệu lực chứng nhận:" ?></b>
                                                </div>
                                                <a href="http://cowater.com/" class="right web"><?= (pll_current_language() == 'en-us') ? "From" : "Từ" ?> <?= $from ?> - <?= (pll_current_language() == 'en-us') ? "To" : "Đến" ?> <?= $to ?></a>
                                            </div>
                                            <div class="child">
                                                <div class="left">
                                                    <div class="icon">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en-us') ? "Address:" : "Địa chỉ:" ?></b>
                                                </div>
