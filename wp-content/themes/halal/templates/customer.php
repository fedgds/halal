    ...
    <div class="section-customer">
        <div class="container">
            ...
            <div class="list-customer" id="list-tab-customer">
                <span><img src="<?= $url ?>/dist/images/section-5-image-1.png" alt=""></span>
                <span><img src="<?= $url ?>/dist/images/section-5-image-2.png" alt=""></span>
                <span><img src="<?= $url ?>/dist/images/section-5-image-3.png" alt=""></span>
                <span><img src="<?= $url ?>/dist/images/section-5-image-4.png" alt=""></span>
                <span><img src="<?= $url ?>/dist/images/section-5-image-5.png" alt=""></span>
                <span><img src="<?= $url ?>/dist/images/section-5-image-1.png" alt=""></span>
            </div>   
            <form action="">
                <div class="search">
            ...
            <table>
                ...
                <tr>
                    <td>Công ty TNHH Giải Pháp Công nghệ W.G</td>
                    <td>Block 7, Lot 20, Dong Hung Thang Area, Bai Chay...</td>
                    <td>12427419231</td>
                    <td>Toàn thế giới</td>
                    <td>Từ 20/05/2023 - Đến 20/05/2024</td>
                </tr>
                <tr>
                    <td>Công ty TNHH Giải Pháp Công nghệ W.G</td>
                    <td>Block 7, Lot 20, Dong Hung Thang Area, Bai Chay...</td>
        ...
        <div class="list-modal-customer">
            <div class="modal" id="modal-customer">
                <div class="child">
                    <span class="image"><img src="<?= $url ?>/dist/images/section-5-image-1.png" alt=""></span>
                    <div class="infor">
                        <h3 class="name">Satori Water</h3>
                        <div class="bottom">
                            <div class="child">
                                <div class="left">
                                    <div class="icon">
                                ...
                                <span class="right phone-number">123456789</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="child">
                    <span class="image"><img src="<?= $url ?>/dist/images/section-5-image-2.png" alt=""></span>
                    <div class="infor">
                        <h3 class="name">Satori Water</h3>
                        <div class="bottom">
                            <div class="child">
                            ...
                            <div class="child">
                                ...
                                <span class="right scope">Lorem Ipsum</span>
                            </div>
                            <div class="child">
                                <div class="left">
                                    <div class="icon">
                                ...
                                <a href="http://cowater.com/" class="right web">http://cowater.com/</a>
                            </div>
                            <div class="child">
                                <div class="left">
                                    <div class="icon">
                                ...
                                <span class="right address">Số 8, đường Hoàng Quốc Việt, Phường Nghĩa Đô, Quận Cầu Giấy, Hà Nội</span>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="child">
                    <span class="image"><img src="<?= $url ?>/dist/images/section-5-image-3.png" alt=""></span>
                    <div class="infor">
                        <h3 class="name">Satori Water</h3>
                        <div class="bottom">
                            <div class="child">
                ...
                <div class="child">
                    <span class="image"><img src="<?= $url ?>/dist/images/section-5-image-4.png" alt=""></span>
                    <div class="infor">
                        <h3 class="name">Satori Water</h3>
                        <div class="bottom">
                            <div class="child">
                ...
                <div class="child">
                    <span class="image"><img src="<?= $url ?>/dist/images/section-5-image-5.png" alt=""></span>
                    <div class="infor">
                        <h3 class="name">Satori Water</h3>
                        <div class="bottom">
                            <div class="child">
...
<script>
    ...
    const modal = document.querySelectorAll('#modal-customer .child');
