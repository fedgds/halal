            ...
            <div class="container">
                ...
                <div class="list-customer" id="list-tab-customer">
                    <div class="wrap">
                        ...
                        <?php else : ?>
                            <p><?= (pll_current_language() == 'en') ? "There are no customers." : "Không có khách hàng nào." ?></p>
                        <?php endif; ?>
                    </div>
                </div>   
                <form action="" id="search-form">
                    <div class="search">
                        <input type="text" id="search-input" placeholder="<?= (pll_current_language() == 'en') ? "Search" : "Tìm kiếm" ?>">
                        <button type="submit">
                    ...
                    <div class="filter">
                        <label for="filter">
                            ...
                            <span><?= (pll_current_language() == 'en') ? "From:" : "Từ:" ?></span>
                        </label>
                    ...
                    <div class="filter">
                        <label for="filter">
                            ...
                            <span><?= (pll_current_language() == 'en') ? "To:" : "Đến:" ?></span>
                        </label>
                                        ...
                                        <div class="bottom">
                                            <div class="child">
                                                <div class="left">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en') ? "Certificate number:" : "Số chứng nhận:" ?></b>
                                                </div>
                                            ...
                                            <div class="child">
                                                <div class="left">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en') ? "Certificate scope:" : "Phạm vi chứng nhận:" ?></b>
                                                </div>
                                            ...
                                            <div class="child">
                                                <div class="left">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en') ? "Certificate validity:" : "Hiệu lực chứng nhận:" ?></b>
                                                </div>
                                                <a href="http://cowater.com/" class="right web"><?= (pll_current_language() == 'en') ? "From" : "Từ" ?> <?= $from ?> - <?= (pll_current_language() == 'en') ? "To" : "Đến" ?> <?= $to ?></a>
                                            </div>
                                            <div class="child">
                                                <div class="left">
                                                    <div class="icon">
                                                    ...
                                                    <b><?= (pll_current_language() == 'en') ? "Address:" : "Địa chỉ:" ?></b>
                                                </div>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const modals = document.querySelectorAll('#modal-customer');
    ...
    function setActiveTab(activeIndex) {
        ...
        modals.forEach(p => p.classList.remove('active'));
        tabs[activeIndex].classList.add('active');
        modals[activeIndex].classList.add('active');
        if (modals[activeIndex].classList.contains('active')) {
    ...
    // Thêm event listener cho document để bắt sự kiện click bên ngoài modal
    document.addEventListener('click', function (event) {
        const activeModal = document.querySelector('#modal-customer.active');
        if (activeModal && !activeModal.contains(event.target) && !event.target.closest('#list-tab-customer')) {
            hideModal();
        }
    });
});
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    searchForm.addEventListener('submit', function (e) {
        ...
        fetch(ajaxurl, {
            ...
            body: 'action=customer_search&search=' + encodeURIComponent(searchTerm),
        })
