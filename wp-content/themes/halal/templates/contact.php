...
<main>
    ...
    <div class="section-contact fade-in">
        <div class="container">
            <h2 class="title">
                <?= (pll_current_language() == 'en-us') ? "Stay in touch with us" : "Giữ liên lạc với chúng tôi" ?>
            </h2>
            <div class="form-and-infor">
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    <h4 class="guide"><?= (pll_current_language() == 'en-us') ? "Leave a message" : "Để lại lời nhắn" ?></h4>
                    ...
                    <div class="line line-1">
                        <input type="text" name="your-name" placeholder="<?= (pll_current_language() == 'en-us') ? "Name" : "Tên" ?>" required>
                        <input type="email" name="your-email" placeholder="Email" required>
                    </div>
                    <div class="line line-2">
                        <select name="your-interest" id="">
                            <option value=""><?= (pll_current_language() == 'en-us') ? "Have an interest in" : "Có hứng thú với" ?></option>
                            <option value="Option 1">Option 1</option>
                            <option value="Option 2">Option 2</option>
                        </select>
                        <input type="tel" name="your-phone" placeholder="<?= (pll_current_language() == 'en-us') ? "Phone number" : "Số điện thoại" ?>" required>
                    </div>
                    <div class="line line-3">
                        <textarea name="your-message" id="" placeholder="<?= (pll_current_language() == 'en-us') ? "Message" : "Lời nhắn" ?>" required></textarea>
                    </div>
                    <button type="submit"><?= (pll_current_language() == 'en-us') ? "Send now" : "Gửi ngay" ?></button>
                ...
                <div class="infor">
                    ...
                    <div class="infor-detail">
                        <div class="phone-number">
                            <h4><?= (pll_current_language() == 'en-us') ? "Call us" : "Gọi cho chúng tôi" ?></h4>
                            <span>
                        ...
                        <div class="address">
                            <h4><?= (pll_current_language() == 'en-us') ? "Association address" : "Địa chỉ hiệp hội" ?></h4>
                            <span>
                        ...
                        <div class="email">
                            <h4><?= (pll_current_language() == 'en-us') ? "E-mail address" : "Địa chỉ e-mail" ?></h4>
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                        ...
                        <div class="social-media">
                            <h4><?= (pll_current_language() == 'en-us') ? "Social Media" : "Mạng xã hội" ?></h4>
                            <div class="list">
            ...
            <div class="mapouter fade-in">
                <div class="gmap_canvas">
                    <iframe width="1368" height="506" id="gmap_canvas" src="https://maps.google.com/maps?q=aeon%20mall%20h%C3%A0%20%C4%91%C3%B4ng&t=&z=13&ie=UTF8&iwloc=&output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"></iframe><a href="https://embedgooglemap.net/124/"></a><style>.mapouter{position:relative;text-align:right;height:506px;width:1368px;}</style><a href="https://www.embedgooglemap.net">embedgooglemap.net</a><style>.gmap_canvas {overflow:hidden;background:none!important;height:506px;width:1368px;}</style>
                </div>
            </div>
        </div>
    </div>
