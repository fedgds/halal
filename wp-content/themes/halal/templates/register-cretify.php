            ...
            <div class="form">
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    ...
                    <div class="form-register">
                        <a href="https://wework.base.vn/mytasks?order=last_update&time_field=last_update&time_condition=is&time_origin_value=recently&stime=19-09-2024&etime=19-10-2024&task=5265441" target="_blank">
                            <span><?= (pll_current_language() == 'en') ? "Certification registration form" : "Form đăng ký chứng nhận" ?></span>
                    ...
                    <div class="line-10">
                        <label for="file">
                            ...
                            <span><?= (pll_current_language() == 'en') ? "Upload the completed form file" : "Tải lên file biểu mẫu đã điền" ?></span>
                        </label>
                        <input type="file" name="file-upload" id="file">
                    </div>
                    <button type="submit"><?= (pll_current_language() == 'en') ? "Confirm" : "Xác nhận" ?></button>
