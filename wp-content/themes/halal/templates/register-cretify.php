            ...
            <div class="form">
                <form action="<?php echo esc_url(admin_url('admin-post.php')); ?>" method="post">
                    <div class="line line-1">
                        <div class="form-group">
                            ...
                            <input type="text" name="org-name" placeholder="Nhập tên tổ chức của bạn"> 
                        </div>
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <input type="text" name="org-address" placeholder="Nhập địa chỉ tổ chức của bạn"> 
                        </div>
                    </div>
                    ...
                    <div class="line line-2">
                        <div class="form-group">
                            ...
                            <input type="text" name="org-rep-name" placeholder="Nhập họ và tên của đại diện">
                        </div>
                    </div>
                    <div class="line line-3">
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <input type="text" name="org-rep-address" placeholder="Nhập địa chỉ của đại diện"> 
                        </div>
                        <div class="form-group">
                            <label>Chức vụ</label>
                            <input type="text" name="org-rep-position" placeholder="Nhập chức vụ của đại diện"> 
                        </div>
                    </div>
                    <div class="line line-4">
                        <div class="form-group">
                            <label>Số điện thoại</label>
                            <input type="text" name="org-rep-phone" placeholder="Nhập số điện thoại của đại diện">
                        </div>
                    </div>
                    <div class="line line-5">
                        <div class="form-group">
                            <label>E-mail</label>
                            <input type="text" name="org-rep-email" placeholder="Nhập e-mail của đại diện"> 
                        </div>
                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" name="org-rep-fax" placeholder="Nhập số fax của đại diện"> 
                        </div>
                    </div>
                    <h3>Người liên hệ</h3>
                    <div class="line line-6">
                        <div class="form-group">
                            <label>Họ và tên</label>
                            <input type="text" name="contact-name" placeholder="Nhập họ và tên của người liên hệ">
                        </div>
                    </div>
                    <div class="line line-7">
                        <div class="form-group">
                            <label>Địa chỉ</label>
                            <input type="text" name="contact-address" placeholder="Nhập địa chỉ của người liên hệ"> 
                        </div>
                        <div class="form-group">
                            <label>Chức vụ</label>
                            <input type="text" name="contact-position" placeholder="Nhập chức vụ của người liên hệ"> 
                        </div>
                    </div>
                    <div class="line line-8">
                        <div class="form-group">
                            <label>Số điện thoại</label>
                            <input type="text" name="contact-phone" placeholder="Nhập số điện thoại của người liên hệ">
                        </div>
                    </div>
                    <div class="line line-9">
                        <div class="form-group">
                            <label>E-mail</label>
                            <input type="text" name="contact-email" placeholder="Nhập e-mail của người liên hệ"> 
                        </div>
                        <div class="form-group">
                            <label>Fax</label>
                            <input type="text" name="contact-fax" placeholder="Nhập số fax của người liên hệ"> 
                        </div>
                    </div>
                ...
                <div class="notice">
                    ...
                    <ul>
                        ...
                        <li>Tài liệu Giới thiệu tổ chức (nếu có)</li>
                        <li>Sơ đồ tổ chức hoặc Văn bản liệt kê các đơn vị/ phòng ban nằm trong hệ thống</li>
                        <li>Tài liệu mô tả phạm vi áp dụng, bao gồm các giới hạn, ranh giới áp dụng, các đơn vị gia công, .v.v…</li>
                        <li>Các Kế hoạch HACCP áp dụng</li>
                        <li>Danh mục các chương trình PRP/PRP áp dụng</li>
                        <li>Sơ đồ đường đi nhà máy</li>
                        <li>Công bố chất lượng sản phẩm</li>
                        <li>Các hồ sơ khác (nếu cần thiết)</li>
                    </ul>
                    <?php if ($contact_query->have_posts()) : $count = 0;?>
