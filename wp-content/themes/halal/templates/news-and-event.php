        ...
        <div class="container">
            <div class="list-menu fade-in">
                                ...
                                <div class="infor">
                                    <div class="date-and-hour">
                                        <div class="date">
                                            ...
                                            <span><span><?= custom_date_format(get_the_date()) ?></span></span>
                                        </div>
                                        <div class="dot">
                ...
                <?php if ($list_news_query->found_posts > 6) : ?>
                        <a href="<?= home_url() ?>/<?= (pll_current_language() == 'en') ? "en/news" : "tin-tuc" ?>" class="view-more"><?= (pll_current_language() == 'en') ? "VIEW MORE" : "XEM THÊM" ?></a>
                <?php endif; ?>
            </div>

            <div class="list-menu fade-in">
                <h2 class="title"><?= (pll_current_language() == 'en') ? "Event" : "Sự kiện" ?></h2>
                <div class="list">
                ...
                <?php if ($list_event_query->found_posts > 6) : ?>
                    <a href="<?= home_url() ?>/<?= (pll_current_language() == 'en') ? "en/event" : "su-kien" ?>" class="view-more"><?= (pll_current_language() == 'en') ? "VIEW MORE" : "XEM THÊM" ?></a>
                <?php endif; ?>
            </div>
        </div>
    </div>
